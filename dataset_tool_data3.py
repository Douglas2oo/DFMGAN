...
def convert_dataset(
    ...
    for idx, image in tqdm(enumerate(input_iter), total=num_files):
        ...
        if source_mask is not None:
            ...
            print(f'Processing image {img_idx} with mask {os.path.join(source_mask, f"{img_idx}{img_ext}")}')
            ...
            mask_name = f'{base}{suffix}{img_ext}'

            img_path = os.path.join(source, image['img_name'])

            mask_path = os.path.join(source_mask, mask_name)            # Load and process the image
            ...
            # If mask is 3-channel, use the first channel as mask
            if mask.ndim == 3:
                mask = mask[:, :, 0]
